 ...
 * @Version 1.0
 */
public class AWLeaAdapter extends BaseToAdapter {

    public List<WinterCloth.WashInfoEntity> mList;

    public AWLeaAdapter(Context context, List<WinterCloth.WashInfoEntity> list) {
        super(context, list);
        this.mList = list;
    }
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView != null) {
            ...
            convertView = getLayoutInflater().inflate(R.layout.item_grid_aw_lea, null);
