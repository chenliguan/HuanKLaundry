 ...
 * @Version 1.0
 */
public class AWSumAdapter extends BaseToAdapter {

    public List<WinterCloth.WashInfoEntity> mList;

    public AWSumAdapter(Context context, List<WinterCloth.WashInfoEntity> list) {
        super(context, list);
        this.mList = list;
    }
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView != null) {
            ...
            convertView = getLayoutInflater().inflate(R.layout.item_grid_aw_sum, null);
